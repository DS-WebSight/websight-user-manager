...
public class GetGroupRestModel extends AuthorizableBaseModel implements Validatable {

    private static final Logger LOG = LoggerFactory.getLogger(GetGroupRestModel.class);
    ...
    public Errors validate() {
        ...
        try {
            ...
            LOG.warn("Could not fetch group {} for get group action", authorizableId, e);
