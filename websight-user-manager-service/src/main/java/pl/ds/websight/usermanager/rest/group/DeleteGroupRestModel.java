...
public class DeleteGroupRestModel extends AuthorizableBaseModel implements Validatable {

    private static final Logger LOG = LoggerFactory.getLogger(DeleteGroupRestModel.class);
    ...
    public Errors validate() {
        ...
        try {
            ...
            LOG.warn("Could not fetch group {} for delete group action", authorizableId, e);
